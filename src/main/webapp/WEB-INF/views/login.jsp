...
<body>
	...
	<div class="container-fluid bg-1 text-center" style="padding-top: 200px; padding-bottom: 100px;">
		<h3 class="margin text-primary">Sell your car within seconds!</h3>
			...
			<div class="col-md-4">
				...
				<form action="${post_url}" method="post">
					...
					<div class="form-group">
						...
						<label class="text-primary" for="username">User Name :</label> <input
							type="text" name="username" id="username" value=""
							class="form-control" required></input>
					</div>

					<div class="form-group">
						<label class="text-primary" for="password">Password :</label> <input
