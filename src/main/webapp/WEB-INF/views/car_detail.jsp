		...
		<h3 class="margin text-center">Detail Car Information !</h3>
				...
				<form:form class="form-horizontal">
					...
					<div class="form-group">
						<label for="price" class="control-label col-sm-4"> <img
							src="/ABC_Car_Portal/images/avator.png" width="60px" alt="..."></label>
			...
			<c:forEach var="car_bidding" items="${bidinfo}">
				...
				<div class="card mb-3 card bg-info" style="padding:10px;">
					...
					<div class="row" >
						<div class="col-md-4">
							<img class="card-img-top" src="/ABC_Car_Portal/images/avator.png" width="30px" class="rounded-circle" class="mr-3" alt="...">
